...
{
    "distutils": {
        "name": "pixel_iteration",
        "sources": [
            "pixel_iteration.pyx"
        ]
    },
    "module_name": "pixel_iteration"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pixel_iteration
#define __PYX_HAVE_API__pixel_iteration
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'pixel_iteration' */
...
static PyObject *__pyx_f_15pixel_iteration_pixel_iteration_fast(int, int, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_15pixel_iteration__predictor(__Pyx_memviewslice, int, int); /*proto*/
static int __pyx_f_15pixel_iteration__nonLinearPredictor(int, int, int); /*proto*/
static PyObject *__pyx_f_15pixel_iteration_toGolomb(int, int, int, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "pixel_iteration"
extern int __pyx_module_is_main_pixel_iteration;
int __pyx_module_is_main_pixel_iteration = 0;

/* Implementation of 'pixel_iteration' */
...
static PyObject *__pyx_pf_15pixel_iteration_pixel_iteration_fast(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_height, int __pyx_v_width, __Pyx_memviewslice __pyx_v_frame); /* proto */
static PyObject *__pyx_pf_15pixel_iteration_2toGolomb(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_val, int __pyx_v_m, int __pyx_v_c, int __pyx_v_div); /* proto */
...
static PyObject *__pyx_pw_15pixel_iteration_1pixel_iteration_fast(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_15pixel_iteration_pixel_iteration_fast(int __pyx_v_height, int __pyx_v_width, __Pyx_memviewslice __pyx_v_frame, CYTHON_UNUSED int __pyx_skip_dispatch) {
  PyObject *__pyx_v_overalls = NULL;
  int __pyx_v_h;
  int __pyx_v_w;
  ...
  int __pyx_t_14;
  __Pyx_RefNannySetupContext("pixel_iteration_fast", 0);

  /* "pixel_iteration.pyx":3
 * # compile this file: python3 setup.py build_ext --inplace
 * cpdef pixel_iteration_fast(int height,int width,unsigned char[:,:,:] frame):
 * 	overalls = ([],[],[])             # <<<<<<<<<<<<<<
 * 	for h in range(height):
 ...
 */
  ...
  __pyx_t_3 = PyList_New(0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = PyTuple_New(3); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 3, __pyx_L1_error)
  ...
  __pyx_t_2 = 0;
  __pyx_t_3 = 0;
  __pyx_v_overalls = ((PyObject*)__pyx_t_4);
  __pyx_t_4 = 0;

  /* "pixel_iteration.pyx":4
 * cpdef pixel_iteration_fast(int height,int width,unsigned char[:,:,:] frame):
 * 	overalls = ([],[],[])
 * 	for h in range(height):             # <<<<<<<<<<<<<<
 * 		for w in range(width):
 ...
 * 
 */
      __pyx_t_11.data = __pyx_v_frame.data;
      __pyx_t_11.memview = __pyx_v_frame.memview;
...
__pyx_t_11.shape[0] = __pyx_v_frame.shape[2];
__pyx_t_11.strides[0] = __pyx_v_frame.strides[2];
    __pyx_t_11.suboffsets[0] = -1;

__pyx_t_4 = __pyx_memoryview_fromslice(__pyx_t_11, 1, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 6, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      ...
      if ((likely(PyTuple_CheckExact(__pyx_t_4))) || (PyList_CheckExact(__pyx_t_4))) {
        ...
        __Pyx_GOTREF(__pyx_t_2);
        __pyx_t_1 = PySequence_ITEM(sequence, 2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        #endif
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      } else {
        Py_ssize_t index = -1;
        __pyx_t_12 = PyObject_GetIter(__pyx_t_4); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 6, __pyx_L1_error)
        ...
        __Pyx_GOTREF(__pyx_t_2);
        index = 2; __pyx_t_1 = __pyx_t_13(__pyx_t_12); if (unlikely(!__pyx_t_1)) goto __pyx_L7_unpacking_failed;
        __Pyx_GOTREF(__pyx_t_1);
        if (__Pyx_IternextUnpackEndCheck(__pyx_t_13(__pyx_t_12), 3) < 0) __PYX_ERR(0, 6, __pyx_L1_error)
        __pyx_t_13 = NULL;
 ...
 * 			diff_y = y - y_p
 */
      __pyx_t_4 = __pyx_f_15pixel_iteration__predictor(__pyx_v_frame, __pyx_v_h, __pyx_v_w); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 7, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      if ((likely(PyTuple_CheckExact(__pyx_t_4))) || (PyList_CheckExact(__pyx_t_4))) {
        PyObject* sequence = __pyx_t_4;
        Py_ssize_t size = __Pyx_PySequence_SIZE(sequence);
        ...
        __Pyx_GOTREF(__pyx_t_2);
        __pyx_t_3 = PySequence_ITEM(sequence, 2); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 7, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        #endif
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      } else {
        Py_ssize_t index = -1;
        __pyx_t_12 = PyObject_GetIter(__pyx_t_4); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 7, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_12);
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
        __pyx_t_13 = Py_TYPE(__pyx_t_12)->tp_iternext;
        ...
        __Pyx_GOTREF(__pyx_t_2);
        index = 2; __pyx_t_3 = __pyx_t_13(__pyx_t_12); if (unlikely(!__pyx_t_3)) goto __pyx_L9_unpacking_failed;
        __Pyx_GOTREF(__pyx_t_3);
        if (__Pyx_IternextUnpackEndCheck(__pyx_t_13(__pyx_t_12), 3) < 0) __PYX_ERR(0, 7, __pyx_L1_error)
        __pyx_t_13 = NULL;
        __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      ...
      __Pyx_XDECREF_SET(__pyx_v_y_p, __pyx_t_1);
      __pyx_t_1 = 0;
      __Pyx_XDECREF_SET(__pyx_v_u_p, __pyx_t_2);
      __pyx_t_2 = 0;
      __Pyx_XDECREF_SET(__pyx_v_v_p, __pyx_t_3);
      __pyx_t_3 = 0;

      /* "pixel_iteration.pyx":9
 * 			y_p, u_p, v_p = _predictor(frame,h,w)
 * 
 * 			diff_y = y - y_p             # <<<<<<<<<<<<<<
 * 			diff_u = u - u_p
 * 			diff_v = v - v_p
 */
      __pyx_t_4 = PyNumber_Subtract(__pyx_v_y, __pyx_v_y_p); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 9, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_XDECREF_SET(__pyx_v_diff_y, __pyx_t_4);
      __pyx_t_4 = 0;

      /* "pixel_iteration.pyx":10
 * 
 * 			diff_y = y - y_p
 * 			diff_u = u - u_p             # <<<<<<<<<<<<<<
 * 			diff_v = v - v_p
 * 
 */
      __pyx_t_4 = PyNumber_Subtract(__pyx_v_u, __pyx_v_u_p); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 10, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_XDECREF_SET(__pyx_v_diff_u, __pyx_t_4);
      __pyx_t_4 = 0;

      /* "pixel_iteration.pyx":11
 * 			diff_y = y - y_p
 * 			diff_u = u - u_p
 * 			diff_v = v - v_p             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_4 = PyNumber_Subtract(__pyx_v_v, __pyx_v_v_p); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 11, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_XDECREF_SET(__pyx_v_diff_v, __pyx_t_4);
      __pyx_t_4 = 0;

      /* "pixel_iteration.pyx":13
 * 			diff_v = v - v_p
 * 
 * 			overalls[0].append(diff_y)             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_t_4 = __Pyx_GetItemInt_Tuple(__pyx_v_overalls, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 13, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      if (unlikely(__pyx_t_4 == Py_None)) {
        PyErr_Format(PyExc_AttributeError, "'NoneType' object has no attribute '%.30s'", "append");
        __PYX_ERR(0, 13, __pyx_L1_error)
      }
      __pyx_t_14 = __Pyx_PyList_Append(__pyx_t_4, __pyx_v_diff_y); if (unlikely(__pyx_t_14 == ((int)-1))) __PYX_ERR(0, 13, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

      /* "pixel_iteration.pyx":14
 * 
 * 			overalls[0].append(diff_y)
 * 			overalls[1].append(diff_u)             # <<<<<<<<<<<<<<
 * 			overalls[2].append(diff_v)
 * 	return overalls
 */
      __pyx_t_4 = __Pyx_GetItemInt_Tuple(__pyx_v_overalls, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 14, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      if (unlikely(__pyx_t_4 == Py_None)) {
        PyErr_Format(PyExc_AttributeError, "'NoneType' object has no attribute '%.30s'", "append");
        __PYX_ERR(0, 14, __pyx_L1_error)
      }
      __pyx_t_14 = __Pyx_PyList_Append(__pyx_t_4, __pyx_v_diff_u); if (unlikely(__pyx_t_14 == ((int)-1))) __PYX_ERR(0, 14, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

      /* "pixel_iteration.pyx":15
 * 			overalls[0].append(diff_y)
 * 			overalls[1].append(diff_u)
 * 			overalls[2].append(diff_v)             # <<<<<<<<<<<<<<
 * 	return overalls
 * 
 */
      __pyx_t_4 = __Pyx_GetItemInt_Tuple(__pyx_v_overalls, 2, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 15, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      if (unlikely(__pyx_t_4 == Py_None)) {
        PyErr_Format(PyExc_AttributeError, "'NoneType' object has no attribute '%.30s'", "append");
        __PYX_ERR(0, 15, __pyx_L1_error)
      }
      __pyx_t_14 = __Pyx_PyList_Append(__pyx_t_4, __pyx_v_diff_v); if (unlikely(__pyx_t_14 == ((int)-1))) __PYX_ERR(0, 15, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    }
  }

  /* "pixel_iteration.pyx":16
 * 			overalls[1].append(diff_u)
 * 			overalls[2].append(diff_v)
 * 	return overalls             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_INCREF(__pyx_v_overalls);
  __pyx_r = __pyx_v_overalls;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("pixel_iteration.pixel_iteration_fast", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_overalls);
...
/* Python wrapper */
static PyObject *__pyx_pw_15pixel_iteration_1pixel_iteration_fast(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_15pixel_iteration_1pixel_iteration_fast(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_height;
  int __pyx_v_width;
  __Pyx_memviewslice __pyx_v_frame = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("pixel_iteration_fast (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_height,&__pyx_n_s_width,&__pyx_n_s_frame,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_width)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("pixel_iteration_fast", 1, 3, 3, 1); __PYX_ERR(0, 2, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_frame)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("pixel_iteration_fast", 1, 3, 3, 2); __PYX_ERR(0, 2, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "pixel_iteration_fast") < 0)) __PYX_ERR(0, 2, __pyx_L3_error)
      }
    ...
    __pyx_v_height = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_height == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 2, __pyx_L3_error)
    __pyx_v_width = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_width == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 2, __pyx_L3_error)
    __pyx_v_frame = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_unsigned_char(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_frame.memview)) __PYX_ERR(0, 2, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("pixel_iteration_fast", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 2, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pixel_iteration.pixel_iteration_fast", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_15pixel_iteration_pixel_iteration_fast(__pyx_self, __pyx_v_height, __pyx_v_width, __pyx_v_frame);
...
static PyObject *__pyx_pf_15pixel_iteration_pixel_iteration_fast(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_height, int __pyx_v_width, __Pyx_memviewslice __pyx_v_frame) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("pixel_iteration_fast", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_frame.memview)) { __Pyx_RaiseUnboundLocalError("frame"); __PYX_ERR(0, 2, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_15pixel_iteration_pixel_iteration_fast(__pyx_v_height, __pyx_v_width, __pyx_v_frame, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_f_15pixel_iteration__predictor(__Pyx_memviewslice __pyx_v_frame, int __pyx_v_pos_h, int __pyx_v_pos_w) {
  int __pyx_v_y_p;
  int __pyx_v_u_p;
  int __pyx_v_v_p;
  ...
  __Pyx_RefNannySetupContext("_predictor", 0);

  /* "pixel_iteration.pyx":20
 * cdef _predictor(unsigned char[:,:,:]frame, int pos_h, int pos_w):
 * 	cdef int y_p,u_p,v_p
 * 	if pos_w-1>=0:             # <<<<<<<<<<<<<<
 ...
 * 	else:
 */
  __pyx_t_1 = (((__pyx_v_pos_w - 1) >= 0) != 0);
  if (__pyx_t_1) {

    /* "pixel_iteration.pyx":21
 * 	cdef int y_p,u_p,v_p
 * 	if pos_w-1>=0:
 * 		a = frame[pos_h,pos_w-1]             # <<<<<<<<<<<<<<
 * 	else:
 * 		a = [0,0,0]
 */
    __pyx_t_2.data = __pyx_v_frame.data;
    __pyx_t_2.memview = __pyx_v_frame.memview;
    __PYX_INC_MEMVIEW(&__pyx_t_2, 0);
    {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_pos_h;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_frame.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_frame.strides[0];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
...
{
    Py_ssize_t __pyx_tmp_idx = (__pyx_v_pos_w - 1);
        Py_ssize_t __pyx_tmp_shape = __pyx_v_frame.shape[1];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_frame.strides[1];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
...
__pyx_t_2.shape[0] = __pyx_v_frame.shape[2];
__pyx_t_2.strides[0] = __pyx_v_frame.strides[2];
    __pyx_t_2.suboffsets[0] = -1;

__pyx_t_3 = __pyx_memoryview_fromslice(__pyx_t_2, 1, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 21, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
 ...
 * 	else:
 */
  __pyx_t_1 = (((__pyx_v_pos_h - 1) >= 0) != 0);
  if (__pyx_t_1) {

    /* "pixel_iteration.pyx":26
 * 
 * 	if pos_h-1>=0:
 * 		b = frame[pos_h-1,pos_w]             # <<<<<<<<<<<<<<
 * 	else:
 ...
 */
    ...
    __PYX_INC_MEMVIEW(&__pyx_t_2, 0);
    {
    Py_ssize_t __pyx_tmp_idx = (__pyx_v_pos_h - 1);
        Py_ssize_t __pyx_tmp_shape = __pyx_v_frame.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_frame.strides[0];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
...
{
    Py_ssize_t __pyx_tmp_idx = __pyx_v_pos_w;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_frame.shape[1];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_frame.strides[1];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
...
__pyx_t_3 = __pyx_memoryview_fromslice(__pyx_t_2, 1, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 26, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __PYX_XDEC_MEMVIEW(&__pyx_t_2, 1);
    __pyx_t_2.memview = NULL;
    __pyx_t_2.data = NULL;
 ...
 * 	else:
 */
  __pyx_t_4 = (((__pyx_v_pos_h - 1) >= 0) != 0);
  if (__pyx_t_4) {
  } else {
    __pyx_t_1 = __pyx_t_4;
    goto __pyx_L6_bool_binop_done;
  }
  __pyx_t_4 = (((__pyx_v_pos_w - 1) >= 0) != 0);
  __pyx_t_1 = __pyx_t_4;
  __pyx_L6_bool_binop_done:;
  if (__pyx_t_1) {

    /* "pixel_iteration.pyx":31
 * 
 * 	if pos_h-1>=0 and pos_w-1>=0:
 * 		c = frame[pos_h-1,pos_w-1]             # <<<<<<<<<<<<<<
 * 	else:
...
__pyx_t_3 = __pyx_memoryview_fromslice(__pyx_t_2, 1, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 31, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __PYX_XDEC_MEMVIEW(&__pyx_t_2, 1);
    __pyx_t_2.memview = NULL;
    __pyx_t_2.data = NULL;
 ...
 */
  ...
  __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_b, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 35, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_6 = __Pyx_PyInt_As_int(__pyx_t_3); if (unlikely((__pyx_t_6 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 35, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_c, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 35, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_7 = __Pyx_PyInt_As_int(__pyx_t_3); if (unlikely((__pyx_t_7 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 35, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_y_p = __pyx_f_15pixel_iteration__nonLinearPredictor(__pyx_t_5, __pyx_t_6, __pyx_t_7);

  /* "pixel_iteration.pyx":36
 * 
 * 	y_p = _nonLinearPredictor(a[0],b[0],c[0])
 * 	u_p = _nonLinearPredictor(a[1],b[1],c[1])             # <<<<<<<<<<<<<<
 * 	v_p = _nonLinearPredictor(a[2],b[2],c[2])
 * 	return y_p,u_p,v_p
 */
  __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_a, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_7 = __Pyx_PyInt_As_int(__pyx_t_3); if (unlikely((__pyx_t_7 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_b, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_6 = __Pyx_PyInt_As_int(__pyx_t_3); if (unlikely((__pyx_t_6 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_c, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyInt_As_int(__pyx_t_3); if (unlikely((__pyx_t_5 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_u_p = __pyx_f_15pixel_iteration__nonLinearPredictor(__pyx_t_7, __pyx_t_6, __pyx_t_5);

  /* "pixel_iteration.pyx":37
 * 	y_p = _nonLinearPredictor(a[0],b[0],c[0])
 * 	u_p = _nonLinearPredictor(a[1],b[1],c[1])
 * 	v_p = _nonLinearPredictor(a[2],b[2],c[2])             # <<<<<<<<<<<<<<
 * 	return y_p,u_p,v_p
 * 
 */
  __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_a, 2, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyInt_As_int(__pyx_t_3); if (unlikely((__pyx_t_5 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_b, 2, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_6 = __Pyx_PyInt_As_int(__pyx_t_3); if (unlikely((__pyx_t_6 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_c, 2, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_7 = __Pyx_PyInt_As_int(__pyx_t_3); if (unlikely((__pyx_t_7 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_v_p = __pyx_f_15pixel_iteration__nonLinearPredictor(__pyx_t_5, __pyx_t_6, __pyx_t_7);

  /* "pixel_iteration.pyx":38
 * 	u_p = _nonLinearPredictor(a[1],b[1],c[1])
 * 	v_p = _nonLinearPredictor(a[2],b[2],c[2])
 * 	return y_p,u_p,v_p             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_y_p); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_8 = __Pyx_PyInt_From_int(__pyx_v_u_p); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_9 = __Pyx_PyInt_From_int(__pyx_v_v_p); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 38, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("pixel_iteration._predictor", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static int __pyx_f_15pixel_iteration__nonLinearPredictor(int __pyx_v_a, int __pyx_v_b, int __pyx_v_c) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;
  int __pyx_t_4;
  __Pyx_RefNannySetupContext("_nonLinearPredictor", 0);

  /* "pixel_iteration.pyx":43
 * # a | X
 * cdef int _nonLinearPredictor(int a, int b, int c):
 * 	if c >= max(a,b):             # <<<<<<<<<<<<<<
 * 		return min(a,b)
 ...
 */
  ...
  __pyx_t_4 = ((__pyx_v_c >= __pyx_t_3) != 0);
  if (__pyx_t_4) {

    /* "pixel_iteration.pyx":44
 * cdef int _nonLinearPredictor(int a, int b, int c):
 * 	if c >= max(a,b):
 * 		return min(a,b)             # <<<<<<<<<<<<<<
 * 	elif c <= min(a,b):
 ...
 */
  ...
  __pyx_t_4 = ((__pyx_v_c <= __pyx_t_1) != 0);
  if (__pyx_t_4) {

    /* "pixel_iteration.pyx":46
 * 		return min(a,b)
 * 	elif c <= min(a,b):
 * 		return max(a,b)             # <<<<<<<<<<<<<<
 * 	else:
 ...
 */
  /*else*/ {
    __pyx_r = ((__pyx_v_a + __pyx_v_b) - __pyx_v_c);
    goto __pyx_L0;
  }
...
static PyObject *__pyx_pw_15pixel_iteration_3toGolomb(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_15pixel_iteration_toGolomb(int __pyx_v_val, int __pyx_v_m, int __pyx_v_c, int __pyx_v_div, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_r;
  int __pyx_v_q;
  int __pyx_v_b;
  PyObject *__pyx_v_unary = NULL;
  ...
  int __pyx_t_5;
  int __pyx_t_6;
  __Pyx_RefNannySetupContext("toGolomb", 0);

  /* "pixel_iteration.pyx":54
 * 	cdef int r,q,b
 * 
 * 	r = val % m             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __pyx_v_r = __Pyx_mod_int(__pyx_v_val, __pyx_v_m);

  /* "pixel_iteration.pyx":55
 * 
 * 	r = val % m
 * 	q =int(math.floor(val / m))             # <<<<<<<<<<<<<<
 * 	unary = "1"*q
 ...
 */
  ...
  else if (sizeof(int) == sizeof(long) && (!(((int)-1) > 0)) && unlikely(__pyx_v_m == (int)-1)  && unlikely(UNARY_NEG_WOULD_OVERFLOW(__pyx_v_val))) {
    PyErr_SetString(PyExc_OverflowError, "value too large to perform division");
    __PYX_ERR(0, 55, __pyx_L1_error)
  }
  __pyx_t_2 = __Pyx_PyInt_From_int(__Pyx_div_int(__pyx_v_val, __pyx_v_m)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 55, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
 ...
 * 	if (r < div):
 */
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_q); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_1 = PyNumber_Multiply(__pyx_kp_s_1, __pyx_t_3); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_unary = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "pixel_iteration.pyx":58
 * 	unary = "1"*q
 * 
 * 	if (r < div):             # <<<<<<<<<<<<<<
 * 		b = c - 1
 * 		binary = "{0:0"+str(b)+"b}"
 */
  __pyx_t_6 = ((__pyx_v_r < __pyx_v_div) != 0);
  if (__pyx_t_6) {

    /* "pixel_iteration.pyx":59
 * 
 * 	if (r < div):
 * 		b = c - 1             # <<<<<<<<<<<<<<
 * 		binary = "{0:0"+str(b)+"b}"
 ...
 */
    __pyx_v_b = (__pyx_v_c - 1);

    /* "pixel_iteration.pyx":60
 * 	if (r < div):
 * 		b = c - 1
 * 		binary = "{0:0"+str(b)+"b}"             # <<<<<<<<<<<<<<
 * 		binary = str(binary.format(r))
 * 	else:
 */
    __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_b); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 60, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_3 = __Pyx_PyObject_CallOneArg(((PyObject *)(&PyString_Type)), __pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 60, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = PyNumber_Add(__pyx_kp_s_0_0, __pyx_t_3); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 60, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PyNumber_Add(__pyx_t_1, __pyx_kp_s_b); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 60, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_v_binary = __pyx_t_3;
    __pyx_t_3 = 0;

    /* "pixel_iteration.pyx":61
 * 		b = c - 1
 * 		binary = "{0:0"+str(b)+"b}"
 * 		binary = str(binary.format(r))             # <<<<<<<<<<<<<<
 * 	else:
 * 		b = c
 */
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_binary, __pyx_n_s_format); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 61, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_r); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 61, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_4 = NULL;
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = __Pyx_PyObject_CallOneArg(((PyObject *)(&PyString_Type)), __pyx_t_3); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 61, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_3 = __Pyx_PyObject_CallOneArg(((PyObject *)(&PyString_Type)), __pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 64, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = PyNumber_Add(__pyx_kp_s_0_0, __pyx_t_3); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 64, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PyNumber_Add(__pyx_t_1, __pyx_kp_s_b); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 64, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_v_binary = __pyx_t_3;
    __pyx_t_3 = 0;

    /* "pixel_iteration.pyx":65
 * 		b = c
 * 		binary = "{0:0"+str(b)+"b}"
 * 		binary = str(binary.format(r+div))             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_binary, __pyx_n_s_format); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 65, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = __Pyx_PyInt_From_int((__pyx_v_r + __pyx_v_div)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 65, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_4 = NULL;
    if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_1))) {
      __pyx_t_4 = PyMethod_GET_SELF(__pyx_t_1);
  ...
  /* "pixel_iteration.pyx":67
 * 		binary = str(binary.format(r+div))
 * 
 * 	return unary+"0"+binary             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyNumber_Add(__pyx_v_unary, __pyx_kp_s_0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyNumber_Add(__pyx_t_1, __pyx_v_binary); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_r = __pyx_t_3;
  __pyx_t_3 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_AddTraceback("pixel_iteration.toGolomb", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_15pixel_iteration_3toGolomb(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_15pixel_iteration_3toGolomb(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_val;
  int __pyx_v_m;
  int __pyx_v_c;
  int __pyx_v_div;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("toGolomb (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_val,&__pyx_n_s_m,&__pyx_n_s_c,&__pyx_n_s_div,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_m)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("toGolomb", 1, 4, 4, 1); __PYX_ERR(0, 51, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_c)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("toGolomb", 1, 4, 4, 2); __PYX_ERR(0, 51, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_div)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("toGolomb", 1, 4, 4, 3); __PYX_ERR(0, 51, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "toGolomb") < 0)) __PYX_ERR(0, 51, __pyx_L3_error)
      }
    ...
    __pyx_v_val = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_val == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 51, __pyx_L3_error)
    __pyx_v_m = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_m == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 51, __pyx_L3_error)
    __pyx_v_c = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_c == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 51, __pyx_L3_error)
    __pyx_v_div = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_div == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 51, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("toGolomb", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 51, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pixel_iteration.toGolomb", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_15pixel_iteration_2toGolomb(__pyx_self, __pyx_v_val, __pyx_v_m, __pyx_v_c, __pyx_v_div);
...
static PyObject *__pyx_pf_15pixel_iteration_2toGolomb(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_val, int __pyx_v_m, int __pyx_v_c, int __pyx_v_div) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("toGolomb", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_15pixel_iteration_toGolomb(__pyx_v_val, __pyx_v_m, __pyx_v_c, __pyx_v_div, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pixel_iteration.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pixel_iteration._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"pixel_iteration_fast", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_15pixel_iteration_1pixel_iteration_fast, METH_VARARGS|METH_KEYWORDS, 0},
  {"toGolomb", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_15pixel_iteration_3toGolomb, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_pixel_iteration(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_pixel_iteration},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initpixel_iteration(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initpixel_iteration(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_pixel_iteration(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_pixel_iteration(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_pixel_iteration(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'pixel_iteration' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_pixel_iteration(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("pixel_iteration", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pixel_iteration) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pixel_iteration")) {
      if (unlikely(PyDict_SetItemString(modules, "pixel_iteration", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pixel_iteration", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pixel_iteration");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
